...
const ACTIVATION_PREREQUISITES = Object.freeze([
  ...
  'Immutable canonical policy-event ledger plus App-comment projection edit/delete/marker/digest tamper restoration canaries.',
  'Newest pending generation evidence for every affected PR head before mutable metadata reads.',
  'Protected-base push allowlist with tag/feature/deletion rejection and current-tip verification before any success.',
  'Startup failure, dropped-delivery recovery, rate-limit, stale-writer, and wrong-App negative canaries.',
  'Reviewer authorization revocation plus fully paginated reconciliation canaries for dropped synchronize/retarget identity drift and reused successful commits.',
