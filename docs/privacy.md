...
| Feedback/support submission, contact details, diagnostics, attachments | Potentially sensitive user/support content | Future intake and remediation | No intake is deployed; the framework is review-ready but unapproved | The proposed [feedback privacy, retention, and data-subject rights decision](legal/feedback-privacy-retention-dsr.md) defines the purpose, field, retention, access, redaction, and deletion recommendation. Provider terms and Cyrus approval remain required before collection. **Future/gated** |
