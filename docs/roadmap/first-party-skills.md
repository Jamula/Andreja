...
## Ownership and finance-adjacent co-lead boundary

Owners listed in the catalog below are Squad's **proposed** Phase 0
assignment, not yet ratified per-skill charters. One general caveat remains
before the relevant row's charter (stage 1) merges:

- **Owners for the 9 skills without a dedicated guardrail subsection in
  `docs/plan.md`** (Open Loops and Tasks, Calendar and Commitments, Personal
  Semantic Profile, Finance Administration, Family and Relationships, Travel
  and Social Planning, Interests/Reading/Podcasts, and Trading Research and
  Review) were inferred from charters and the team roster rather than lifted
  verbatim from a plan.md guardrail section. Confirm at each skill's charter
  issue.

Cyrus's ownership decision for [issue #37](https://github.com/Jamula/Andreja/issues/37)
names Quark as Seven of Nine's co-lead only for Finance Administration, Trading
Research and Review, Lifestyle Rewards and Financial Optimization, Miles and
Points Manager, and Employer Benefits and Perks Manager. These boundaries apply:

- Company accounting, product tenant metering, and each user's finance/rewards
  records are independent ledgers. They have no shared source of truth and no
  cross-ledger write or reconciliation.
- Finance/rewards records remain in user-controlled, tenant-isolated custody.
  Quark has no standing access to user records and receives only minimized,
  non-user consultation evidence.
- Quark discloses company-side conflicts and may advise. Seven alone makes the
  product recommendation.
- Before user-specific guidance, Sarek classifies applicability and an
  independent, appropriately qualified human approves the methodology and
  user-facing claims.
- Only Cyrus may authorize launch through explicit recorded approval, based on
  Seven's recommendation and completed specialist gates. Quark has neither
  launch authority nor veto.
...
| `In implementation` | Experience/help design and implementation (Skill Development Framework steps 4–5) are underway, behind `ISkillHost`, not yet reviewed or dogfooded. |
| `In review` | Safety/privacy/security review and validation (Skill Development Framework steps 6–7) are underway — step 7 is the first step requiring live-model calls under the AI-credit envelope. |
| `Dogfood` | Smallest complete vertical slice running for Cyrus/Customer Zero (Skill Development Framework step 8). |
...
| 5 | Finance Administration | Track bills, banking follow-ups, and budgets/checklists | Seven of Nine (product recommendation and skill framework); Quark (finance co-lead; methodology) | Early | 2 | Open Loops and Tasks | Charter pending | [plan §Core product roadmap](../plan.md#core-product-roadmap); [ownership #37](https://github.com/Jamula/Andreja/issues/37) | Bills/banking follow-ups/budgets/checklists only — no money movement or trading execution. |
...
| 11 | Trading Research and Review | Maintain trading watchlists, thesis notes, and journal reminders (no execution) | Seven of Nine (product recommendation and skill framework); Quark (finance co-lead; valuation/financial framing) | Later first-party | 4 | Open Loops and Tasks | Charter pending | [plan §Core product roadmap](../plan.md#core-product-roadmap); [ownership #37](https://github.com/Jamula/Andreja/issues/37) | Watchlists/thesis/journal reminders only; no brokerage connection or order execution (explicitly deferred, see [plan §Explicitly not day-one work](../plan.md#explicitly-not-day-one-work)). |
| 12 | Lifestyle Rewards and Financial Optimization | Aggregate lifestyle rewards/points value and optimization opportunities read-only | Seven of Nine (product recommendation and skills/channels); Quark (finance/rewards co-lead; economic/value methodology); Tuvok (financial-action security); Deanna Troi (data minimization); Sarek (regulatory/terms); Data (reconciliation quality) | Regulated/later | 11 | Miles and Points Manager; Loyalty/rewards channel; Finance Administration | Charter pending | [plan §Lifestyle rewards, miles, and points guardrails](../plan.md#lifestyle-rewards-miles-and-points-guardrails); [ownership #37](https://github.com/Jamula/Andreja/issues/37) | Read-only aggregation by default; no stored card numbers/CVV/passwords; no credential scraping or card churning. |
| 13 | Miles and Points Manager | Track miles/points balances, transfer ratios, and time-sensitive valuations | Seven of Nine (product recommendation and skill lead); Quark (finance/rewards co-lead; valuation methodology); Tuvok; Deanna Troi; Sarek; Data (same specialist set as row 12) | Regulated/later | 11 | Loyalty/rewards channel | Charter pending | [plan §Lifestyle rewards, miles, and points guardrails](../plan.md#lifestyle-rewards-miles-and-points-guardrails); [ownership #37](https://github.com/Jamula/Andreja/issues/37) | Valuations/transfer ratios/fees shown as time-sensitive estimates, never guaranteed value or financial advice. |
| 14 | Employer Benefits and Perks Manager | Inventory and remind on employer benefits/perks and what-if scenarios | Seven of Nine (product recommendation and skill/channel design); Quark (finance/benefits co-lead; benefit-value methodology); Sarek (plan/tax/legal boundaries); Tuvok (high-assurance actions); Deanna Troi (privacy); Beverly Crusher (health-benefit boundaries); Data (reconciliation) | Sensitive/later | 11 | Employer benefits/perks channel; Finance Administration | Charter pending | [plan §Employer Benefits and Perks Manager guardrails](../plan.md#employer-benefits-and-perks-manager-guardrails); [ownership #37](https://github.com/Jamula/Andreja/issues/37) | Document/inventory/reminder/what-if only; no individualized tax/investment/ERISA/legal advice; no stored employer/payroll passwords. |
