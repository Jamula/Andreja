...
assignment, not yet ratified per-skill charters. Two items are flagged for
explicit confirmation before the relevant row's charter (stage 1) merges:
...
- **Owners for the 9 skills without a dedicated guardrail subsection in
  ...
  issue.
- **Quark's role on rows 5, 11, 12, and 13** (Finance Administration; Trading
  Research and Review; Lifestyle Rewards and Financial Optimization; Miles
  and Points Manager): per
  [`docs/operating-model.md`](../operating-model.md#workstream-charters-owners-and-boundaries)'s
  ratified workstream table, the First-party Skills and Developer Ecosystem
  workstream is led by **Seven of Nine plus domain leads**; Quark's ratified
  workstreams are Executive/Business and Platform Operations/FinOps — not
  First-party Skills. This pass reorders those four rows to name Seven of
  Nine as the accountable Skill Framework owner and repositions Quark as
  financial/economic domain input, consistent with Household (#8), Life
  Event Planner (#17), and Small Business (#19). **Open question:** should
  Quark instead be added as a named co-lead of the Skills workstream for
  financial-domain skills specifically (an `docs/operating-model.md`
  change), or is a dedicated Finance/Trading domain specialist needed since
  none is currently named in the roster for personal-finance product
  ownership? Unresolved pending Phase 0 ratification by Picard/Seven/Quark.
...
| 5 | Finance Administration | Track bills, banking follow-ups, and budgets/checklists | Seven of Nine (skill framework); Quark (financial domain input) | Early | 2 | Open Loops and Tasks | Charter pending | [plan §Core product roadmap](../plan.md#core-product-roadmap) | Bills/banking follow-ups/budgets/checklists only — no money movement or trading execution. |
