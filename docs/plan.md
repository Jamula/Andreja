...
| [`docs/frameworks/feedback-support.md`](frameworks/feedback-support.md) | Framework issue [#10](https://github.com/Jamula/Andreja/issues/10), source PR [#16](https://github.com/Jamula/Andreja/pull/16), successor gates [#155](https://github.com/Jamula/Andreja/issues/155)-[#158](https://github.com/Jamula/Andreja/issues/158); `417bb7d34a3a1c4823348f218ab17ddcafa770574701d0f8f5dc46d256a152d4` | **Phase 0 framework decision complete.** Cyrus directed closure of #10 and delegated implementation details to Guinan and the relevant specialists; only consolidated gate packages return for approval. Collection, publication, providers, spend, deployment, launch, email, and support commitments remain unauthorized until the successor gates pass. |
...
| [`docs/privacy.md`](privacy.md) | Issue [#116](https://github.com/Jamula/Andreja/issues/116), PR [#117](https://github.com/Jamula/Andreja/pull/117); `d21cf3fde7de3946f1bbb6267582031926e6b91dec7ecc3367b54301a3fa79e5` | **Canonical descriptive baseline; not ratified.** Required challenge: Deanna Troi (privacy), Tuvok (security), Rai (AI safety); pending. Cyrus residual-risk acceptance remains pending. The classification/impact assessment remains open unless explicitly approved with cited evidence. |
