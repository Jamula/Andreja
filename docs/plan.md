...
|---|---|---|
| [`docs/operating-model.md`](operating-model.md) | Issue [#14](https://github.com/Jamula/Andreja/issues/14), PR [#17](https://github.com/Jamula/Andreja/pull/17); `9293a8dfe991fa44fb4f0f9001e5506b025840ebc7d7553180021a8dc76d3d64` | **Draft for ratification.** The issue and PR merged/closed, but no separate explicit Cyrus ratification record was found; it is advisory and the plan remains authoritative. |
...
| [`docs/frameworks/feedback-support.md`](frameworks/feedback-support.md) | Framework issue [#10](https://github.com/Jamula/Andreja/issues/10), source PR [#16](https://github.com/Jamula/Andreja/pull/16), handoff PR [#159](https://github.com/Jamula/Andreja/pull/159), successor gates [#155](https://github.com/Jamula/Andreja/issues/155)-[#158](https://github.com/Jamula/Andreja/issues/158); `cfae500b89c9ef26fd2afe690b3da0a182614127a9b7cf54750e7c4be90e7f4c` | **Phase 0 framework decision complete.** Cyrus directed closure of #10 and delegated implementation details to Guinan and the relevant specialists; only consolidated gate packages return for explicit recorded approval. Closing a successor issue or merging its documentation is not approval. After #155-#157 are explicitly approved, #158 may request a separate, expiring Cyrus authorization for a synthetic-only non-production evidence exercise; that authorization does not approve production/public collection, publication, deployment, launch, general email, or support commitments. |
...
| [`docs/privacy.md`](privacy.md) | Issue [#116](https://github.com/Jamula/Andreja/issues/116), PR [#117](https://github.com/Jamula/Andreja/pull/117); `293f1d2440cf2e5e8b91bcc96dd652c95a8f4104e51678399fb3e790676759c3` | **Canonical descriptive baseline; not ratified.** Required challenge: Deanna Troi (privacy), Tuvok (security), Rai (AI safety); pending. Cyrus residual-risk acceptance remains pending. The classification/impact assessment remains open unless explicitly approved with cited evidence. |
