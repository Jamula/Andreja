...
| Feedback/support lifecycle | Accepted Phase 0 framework in `docs/frameworks/feedback-support.md` (issue #10); operational activation remains gated by issues #155-#158 | Guinan |
...
- Feedback and support lifecycle (accepted Phase 0 framework under issue #10;
  operational gates tracked in issues #155-#158):
