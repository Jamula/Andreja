...
- [ ] A clean host starts the pinned Compose bundle without GitHub or Andreja cloud.
- [ ] Passkey first-admin bootstrap works once; collision, replay, origin, rate-limit,
      second-passkey, recovery-code, session invalidation, and break-glass cases pass.
